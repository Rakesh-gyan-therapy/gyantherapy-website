...
const PostCard = (props: PostCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="thumbnail w-full h-[220px] relative overflow-hidden rounded-xl">
        <img
          src={props.imageUrl}
          alt="Post thumbnail"
          className={`w-full h-full ${props.source=='instagram'? 'object-contain': 'object-cover'} ${props.source=='youtube'?'xl:scale-100 scale-150':''}`}
        />
